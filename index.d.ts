...
interface EventMpPool {
    ...
    add(
        eventName: RageEnums.EventKey.CLICK,
        callback: (
            x: number,
            y: number,
            upOrDown: string,
    ...
    add(
        eventName: RageEnums.EventKey.EXPLOSION,
        callback: (sourcePlayer: PlayerMp, type: RageEnums.Explosions, position: Vector3Mp) => void | boolean,
    ): void;
    add(eventName: RageEnums.EventKey.GUI_READY, callback: () => void): void;
    add(
        eventName: RageEnums.EventKey.INCOMING_DAMAGE,
        callback: (sourceEntity: EntityMp, sourcePlayer: PlayerMp, targetEntity: EntityMp, weapon: number, boneIndex: number, damage: number) => void,
    ): void;
    add(
        eventName: RageEnums.EventKey.OUTGOING_DAMAGE,
        callback: (sourceEntity: EntityMp, targetEntity: EntityMp, targetPlayer: PlayerMp, weapon: number, boneIndex: number, damage: number) => void,
    ): void;
    ...
    add(
        eventName: RageEnums.EventKey.PROJECTILE,
        callback: (sourcePlayer: PlayerMp, weaponHash: Hash, ammoType: Hash, position: Vector3Mp, direction: Vector3Mp) => void | boolean,
    ): void;
    add(
        eventName: RageEnums.EventKey.RENDER,
        callback: (nametags: [PlayerMp, number, number, number][] | [PlayerMp, number, number, number, number][]) => void,
    ): void;
